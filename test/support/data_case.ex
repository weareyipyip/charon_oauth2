defmodule CharonOauth2.DataCase do
  ...
  by setting `use CharonOauth2.DataCase, async: true`, although
  ...
  setup tags do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(CharonOauth2.Test.Repo, shared: not tags[:async])
